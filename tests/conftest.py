...
# Ensure project root is importable when tests are run from nested paths.
...
class FakeProwlarrClient:
    ...
    def search(self, query: str, indexer_ids=None, categories=None, offset: int = 0, limit: int = 100, should_cancel=None):
        return []
